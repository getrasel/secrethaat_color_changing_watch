...
export const WhatsAppButton: React.FC = () => {
  ...
  const message =
    "হ্যালো, আমি 2-in-1 Astronaut Reading Lamp & Alarm Clock সম্পর্কে বিস্তারিত জানতে ও অর্ডার করতে চাই।";
  ...
  return (
    <aside
      ...
      className="fixed bottom-[84px] md:bottom-6 right-4 sm:right-6 z-40 transition-all duration-300"
    >
      <a
        href={whatsappUrl}
        target="_blank"
